...
/**
 Initializer of this class
 @param ct The color temperature value in Mired 10 - 600
 @param brightness The brightness component for the color.
                   In case you want to extract RGB colors (UI e.g.) pass 1.0 as brightness
 @param model The model of the lightpoint to convert for
 @param swVersion The software version of the lightpoint to convert for
 */
...
/**
 CT The color temperature value in Mired 10 - 600
 */
+ (instancetype)createWithCTMired:(int)ct brightness:(double)brightness ;
