...
/**
 The successfully changed archetype
 */
@property(nonatomic,readonly) PHSLightArchetype lightArchetype;

/**
 The successfully changed archetype
 */
@property(nonatomic,readonly) PHSLightDirection lightDirection;

/**
 The successfully changed archetype
 */
@property(nonatomic,readonly) PHSLightFunction lightFunction;

/**
 The successfully changed startup mode
 */
@property(nonatomic,readonly) PHSStartUpMode startUpMode;
