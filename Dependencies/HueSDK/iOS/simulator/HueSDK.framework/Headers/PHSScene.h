...
/**
 The type of the scene: a light scene, or a group scene
 */
@property (nonatomic, readonly) PHSSceneType sceneType;

/**
 The identifier of the group (room) to which this scene applies
 */
