...
typedef NS_ENUM(NSInteger, PHSBridgeConnectionEvent) {
    ...
    PHSBridgeConnectionEventLoginInvalidated             = 16
};
 ...
 */
@protocol PHSBridgeConnectionObserver
...
/**
 Unregister for connection events and errors
 @param observer Observer that unregisters from connection events and errors
 */
