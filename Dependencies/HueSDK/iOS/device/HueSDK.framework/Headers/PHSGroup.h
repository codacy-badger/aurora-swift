...
#import "PHSAggregatedPresenceSensorState.h"
...
@property (strong, nonatomic, readonly) PHSAggregatedPresenceSensorState *aggregatedPresenceSensorState;
...
- (void)addSensor:(PHSSensor*)sensor;

- (BOOL)hasSensor:(PHSSensor*)sensor;

- (BOOL)removeSensor:(PHSSensor*)sensor;
