...
/**
 * Creates a new username by virtually pressing the link button.
 * Any error in an intermediate step might leave the connection in an unspecified state.
 */
- (void)refreshUsernameWithCompletionHandler:(PHSBridgeResponseCompletionHandler)completionHandler;
...
/**
 @deprecated: use PHSBridgeState::removeStateUpdateObserver instead
 */
- (void)removeStateUpdateObserver:(id<PHSBridgeStateUpdateObserver>)observer __attribute__((deprecated));

/**
 Register observer for connection events and errors
 @deprecated: use addBridgeConnectionObserver instead
 */
- (void)setBridgeConnectionObserver:(id<PHSBridgeConnectionObserver>)observer __attribute__((deprecated));

/**
 Register observer for connection events and errors
 */
- (void)addBridgeConnectionObserver:(id<PHSBridgeConnectionObserver>)observer;

/**
 Unregister observer from connection events and errors
 */
- (void)removeBridgeConnectionObserver:(id<PHSBridgeConnectionObserver>)observer;
