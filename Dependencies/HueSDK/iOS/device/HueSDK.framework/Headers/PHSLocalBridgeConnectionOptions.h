...
/**
 ...
 @param deviceName Device name to be used for authentication
 */
- (instancetype)initWithIpAddress:(NSString *)ipAddress appName:(NSString *)appName deviceName:(NSString *)deviceName bridgeConnectionProtocol:(PHSBridgeConnectionProtocol)bridgeConnectionProtocol;
...
/**
 ...
 @param deviceName Device name to be used for authentication
 */
+ (instancetype)optionsWithIpAddress:(NSString *)ipAddress appName:(NSString *)appName deviceName:(NSString *)deviceName bridgeConnectionProtocol:(PHSBridgeConnectionProtocol)bridgeConnectionProtocol;
...
/**
 Use HTTPS ?
 */
@property (nonatomic) PHSBridgeConnectionProtocol bridgeConnectionProtocol;
