...
//    PHSClipConditionAttributeGroupStateLastSwitched
    PHSClipConditionAttributeGroupPresenceSensorStatePresence,
    PHSClipConditionAttributeGroupPresenceSensorStatePresenceAll,
    PHSClipConditionAttributeGroupPresenceSensorStateLastUpdated
};
